...
build/X86/gem5.opt --debug-flags=O3PipeView,O3CPUAll,Cache,LVPAll,DumpRegs --debug-file=trace.out --outdir=${OUTPUT_DIR} configs/deprecated/example/new_se.py --cpu-type=X86O3CPU --lvp=True --scalar=True --cmd=/home/rapiduser/gem5VP/microbenchmarks/bin/${BENCHMARK_NAME} --caches --l1d_size=64 --l1d_assoc=1 --l2_size=1MB --l2_assoc=1
