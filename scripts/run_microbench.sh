...
build/X86/gem5.opt --debug-flags=O3PipeView,Cache --debug-file=trace.out configs/deprecated/example/se.py --cpu-type=DerivO3CPU --cmd=/home/rapiduser/gem5VP/microbenchmarks/bin/bench --caches --l1d_size=64kB --l1d_assoc=1 --l2_size=1MB --l2_assoc=1
